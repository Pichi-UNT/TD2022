...
void ConfigurarMODEM(LPC_USART_T *pUART_USB, LPC_USART_T *pUART_MODEM)
{
    ...
    if (1)
    {
        UARTEscribirByte(pUART_MODEM,"AT\r\n");
        UARTEscribirByte(pUART_MODEM,"AT+NAME=modulo-b\r\n");
        UARTEscribirByte(pUART_MODEM,"AT+ROLE=0\r\n");
        UARTEscribirByte(pUART_MODEM,"AT+PSWD=1234\r\n");
        UARTEscribirByte(pUART_MODEM,"AT+INIT\r\n");
        UARTEscribirByte(pUART_MODEM,"AT+INQ\r\n");
    }
}
